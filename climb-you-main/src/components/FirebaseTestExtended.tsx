...
const FirebaseTestExtended: React.FC = () => {
  ...
  const testHybridStorage = async () => {
    ...
    try {
      ...
      Alert.alert('Error', `Hybrid storage test failed: ${(error as Error).message}`);
    }
    setIsLoading(false);
  };
  ...
  const testHybridRead = async () => {
    ...
    try {
      ...
      Alert.alert('Error', `Failed to read from hybrid storage: ${(error as Error).message}`);
    }
    setIsLoading(false);
  };
  ...
  const testOpenAIService = async () => {
    ...
    try {
      ...
      Alert.alert('Error', `OpenAI service test failed: ${(error as Error).message}`);
    }
    setIsLoading(false);
  };
  ...
  const testForceSync = async () => {
    ...
    try {
      ...
      Alert.alert('Error', `Force sync failed: ${(error as Error).message}`);
    }
    setIsLoading(false);
  };
